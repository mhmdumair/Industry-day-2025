...
export function LoginForm({
    ...
    const handleGoogleLogin = () => {
        // This initiates the Google OAuth flow. The backend handles the redirect.
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="grid gap-6">
                            ...
                            <div className="flex flex-col gap-4">
                                <Button variant="outline" className="w-full border-black" type="button" onClick={handleGoogleLogin}>
