...
const HomeAnnouncement = () => {
    ...
    return (
        <div className="w-full flex justify-center">
            <Card className="w-11/12 shadow-sm pb-2 pt-2 bg-gray-100 border border-black flex flex-col items-center">
                {/* Title Section */}
                <div className="flex items-center justify-center w-11/12 pt-4">
                ...
                {/* Search & Info Section */}
                <div className="flex flex-col items-center justify-center pb-4 px-3 w-11/12">
                    {/* Search Bar */}
                    <div className="flex gap-2 mb-5 w-11/12 items-center justify-center">
                        <Input
                            placeholder="Search announcements..."
                            value={searchTerm}
                            onChange={(e) => setSearchTerm(e.target.value)}
                            className="w-11/12 border-gray-500 bg-white"
                        />
                    </div>

                    {/* Result Count */}
                    <div className="flex justify-center mb-4 w-11/12">
                    ...
                    {/* Table Section */}
                    <div className="w-11/12 rounded-md border overflow-hidden">
                        ...
                        <div className="overflow-x-auto">
                            ...
                            <ScrollArea className="max-h-[275px]">
                                <table className="min-w-[600px] w-full">
