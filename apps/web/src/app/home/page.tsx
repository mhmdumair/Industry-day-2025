                    ...
                    <Card className="w-full p-4 sm:p-6 lg:p-8 bg-transparent border-none shadow-none">
                        ...
                        {bronzeSponsors.length > 0 && (
                            <div className="flex flex-col items-center justify-center">
                                <h3 className="text-lg sm:text-xl font-semibold text-center mb-4 sm:mb-6 text-gray-800">Bronze Partners</h3>
                                <div className="grid grid-cols-3 sm:grid-cols-4 lg:grid-cols-5 gap-2 sm:gap-3 lg:gap-4">
                                    {bronzeSponsors.map((sponsor) => (
                                        <SponsorDialog
                                            ...
                                            sponsor={transformSponsorData(sponsor)}
                                            triggerComponent={
                                                <div className="w-full aspect-square bg-gradient-to-br from-orange-100 to-orange-200 hover:from-orange-200 hover:to-orange-300 rounded-lg flex items-center justify-center text-orange-800 text-xs font-medium cursor-pointer transition-all duration-200 p-2 border border-orange-300 shadow-sm hover:shadow-md text-center">
                                                    {sponsor.logo ? (
                                                        <img
                                                            src={`/logo/${sponsor.logo}`} 
                                                            alt={`${sponsor.companyName} logo`}
